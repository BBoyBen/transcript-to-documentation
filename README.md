...
├── prompts/
│   ├── generic-doc-transformation-agent.prompt.md  ← Legacy agent generator
│   ├── generate-doc-plan.prompt.md             ← Legacy plan generator
│   └── execute-doc-plan.prompt.md              ← Legacy plan executor
├── instructions/
...
- Replaces `generate-doc-plan.prompt.md` for the main workflow
...
- Replaces the `generic-doc-transformation-agent.prompt.md` + `execute-doc-plan.prompt.md` chain for the main workflow
...
Legacy prompts remain available for compatibility or experimentation, but the recommended workflow now uses the two dedicated agents above.

#### `generate-doc-plan.prompt.md`
**Role**: Legacy execution plan generator
...
- **Status**: Superseded by `doc-planner.agent.md` for the main workflow

#### `generic-doc-transformation-agent.prompt.md`
**Role**: Legacy documentation agent generator
- Produces custom `create-docs` agent
- Adapted to your structure and domains
- **Utilizes the execution plan** generated by `generate-doc-plan.prompt.md`
- Input: Source files + parameters + execution plan
- Output: `.github/agents/create-docs.agent.md`
- **Status**: Superseded by `doc-plan-executor.agent.md` for the main workflow

#### `execute-doc-plan.prompt.md`
**Role**: Legacy plan executor
